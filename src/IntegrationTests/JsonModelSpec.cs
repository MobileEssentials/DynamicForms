...
namespace UnitTests
{
	public class JsonModelSpec
	{
		static JsonModelSpec()
		{
...
");
			...
			Assert.IsAssignableFrom<JsonModel> (model.Property ("Address").Value.Value<JObject> ());
			Assert.IsAssignableFrom<JsonModel> (model.Property ("Address").Value.Value<JObject> ().Property("Phone").Value.Value<JObject>());
